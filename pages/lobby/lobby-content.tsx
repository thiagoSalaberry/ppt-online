...
export function LobbyContent({index, gameroomId, gameroom, room, player}: {index:number, gameroomId:string, gameroom:GameroomData, room:GameroomData, player:PlayerAPIResponse}) {
